...
`product-backlog.md` の変更をコミットする場合、このプロジェクトでは commitlint が有効なため
subject は小文字またはひらがな・漢字始まりにする（`sentence-case` 禁止）。

- NG: `docs(PBI-ph0-010): PBI-ph0-010を完了マーク`（英大文字始まり）
- OK: `docs(PBI-ph0-010): mark pbi-ph0-010 as completed`
- OK: `docs(PBI-ph0-010): バックログの完了マーク`（ひらがな始まりは通る）
